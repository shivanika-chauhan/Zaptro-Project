...
import EmptyCart from "../assets/b.jpg"
        ...
        <div>
            ...
            {cartItem.map((item, index) => (
              ...
              >
                ...
                <span
                  ...
                  className='hover:bg-white/60 transition-all rounded-full hover:shadow-2xl'
                >
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 md:gap-20'>
            ...
            <div className='bg-gray-100 rounded-md p-7 mt-4 space-y-2'>
              <h1 className='text-gray-500 font-bold text-xl'>Delivery Info</h1>
              ...
              <div className='flex flex-col space-y-1'>
                <label>Address</label>
                <input type="text" className='p-2 rounded-md' value={location?.count} readOnly />
              </div>
              ...
              <div className='flex w-full gap-5'>
                ...
                <div className='flex flex-col space-y-1 w-full'>
                  ...
                  <input type="text" placeholder='Enter your phone no.' className='p-2 rounded-md w-full' />
                </div>
              </div>
              <button className='bg-red-500 text-white px-3 py-1 rounded-md mt-3 cursor-pointer'>Submit</button>
              <div className='flex items-center w-full text-gray-700 justify-center'>------OR------</div>
            ...
            {/* Bill Details */}
            <div className='bg-white border border-gray-100 shadow-xl rounded-md mt-4 space-y-4 p-5 h-max'>
